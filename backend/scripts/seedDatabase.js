...
function buildSeedDataset() {
  ...
  const auditLogs = [
    ...
    buildAuditLog(makeStampedId('AUD', 9), AUDIT_ACTIONS.SCHEDULE_CREATE, 'schedule', actor(ids.adminOperations, 'ops-admin@chengeto.health', 'admin'), { type: 'schedule', id: ids.schedules[3], model: 'CareSchedule', description: 'Diabetes care plan' }, { message: 'Created care schedule with medication reminders.' }, daysAgo(10)),
