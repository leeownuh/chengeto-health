...
| Info | Informational | http://chengeto-backend:5000 | Percentage of responses with status code 2xx | 5 % |
| Info | Informational | http://chengeto-backend:5000 | Percentage of responses with status code 4xx | 87 % |
| Info | Informational | http://chengeto-backend:5000 | Percentage of responses with status code 5xx | 7 % |
...
| Info | Informational | http://chengeto-backend:5000 | Percentage of slow responses | 34 % |
...
* URL: http://chengeto-backend:5000/
  ...
  * Other Info: ``
* URL: http://chengeto-backend:5000/api/v1
  * Node Name: `http://chengeto-backend:5000/api/v1`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `authorization:`
